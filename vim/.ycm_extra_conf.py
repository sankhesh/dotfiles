...
if os.path.exists(compilation_database_folder):
    cmake_commands = os.path.join(compilation_database_folder, 'compile_commands.json')
...
def Settings(**kwargs):
    ...
    if language == 'cfamily':
        ...
        #  filename = FindCorrespondingSo(kwargs['filename'])
...
def PythonSysPath(**kwargs):
    ...
    sys_path[0:0] = [os.path.join(DIR_OF_THIS_SCRIPT),
                     ...
                     os.path.join(DIR_OF_THIRD_PARTY, 'cregex',
                     ...
                     os.path.join(DIR_OF_THIRD_PARTY, 'requests_deps',
                                  'urllib3',
                                  'src'),
                     os.path.join(DIR_OF_THIRD_PARTY, 'requests_deps',
                                  'chardet'),
