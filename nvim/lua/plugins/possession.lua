...
return {
  {
    ...
    config = function()
      require('possession').setup({
        -- session_dir = (Path:new(vim.fn.stdpath('config')) / 'sessions'):absolute(),
        session_dir = vim.fn.stdpath('config') .. '/sessions/', -- Change save directory
        silent = false,
        load_silent = true,
        debug = false,
        logfile = false,
